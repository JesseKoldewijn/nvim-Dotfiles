...
_G.packer_plugins = {
  fd = {
    loaded = true,
    path = "/home/jesse/.local/share/nvim/site/pack/packer/start/fd",
  ...
  nitepal = {
    loaded = true,
    path = "/home/jesse/.local/share/nvim/site/pack/packer/start/nitepal",
    url = "https://github.com/jascha030/nitepal.nvim"
  },
  ["nvim-rg"] = {
    loaded = true,
    path = "/home/jesse/.local/share/nvim/site/pack/packer/start/nvim-rg",
